...
function RemoveLoadingBox(){
  document.getElementById("codeLoadingBox").remove();
}
function PrintLineNumbers(){
    let box = document.getElementById("codeLeftColumn");
    if(!box) return;
    let strings = [];
    for(let i=1;i<=9999;i++) strings.push(i);
    box.innerHTML = strings.join("<br>");
}
...
function w3CodeColorize(x, lang) {
  ...
  function tagMode(txt) {
    ...
    result = done + rest;
    result = "<span class='tagcolor' stylezzzzzz=color:" + tagcolor + ">&lt;</span>" + result.substring(4);
    if (result.substr(result.length - 4, 4) == "&gt;") {
      result = result.substring(0, result.length - 4) + "<span class='tagcolor' stylezzzzzz=color:" + tagcolor + ">&gt;</span>";
    }
    return "<span class='tagnamecolor' stylezzzzzz=color:" + tagnamecolor + ">" + result + "</span>";
  }
  function attributeMode(txt) {
    ...
    return "<span class='attributecolor' stylezzzzzz=color:" + attributecolor + ">" + done + rest + "</span>";
  }
  function attributeValueMode(txt) {
    return "<span class='attributevaluecolor' stylezzzzzz=color:" + attributevaluecolor + ">" + txt + "</span>";
  }
  function angularMode(txt) {
    return "<span class='angularstatementcolor' stylezzzzzz=color:" + angularstatementcolor + ">" + txt + "</span>";
  }
  function commentMode(txt) {
    return "<span class='commentcolor' stylezzzzzz=color:" + commentcolor + ">" + txt + "</span>";
  }
  function cssMode(txt) {
    ...
    rest = done + rest;
    rest = rest.replace(/{/g, "<span class='cssdelimitercolor' stylezzzzzz=color:" + cssdelimitercolor + ">{</span>");
    rest = rest.replace(/}/g, "<span class='cssdelimitercolor' stylezzzzzz=color:" + cssdelimitercolor + ">}</span>");
    for (i = 0; i < comment.arr.length; i++) {
      rest = rest.replace("W3CSSCOMMENTPOS", comment.arr[i]);
    }
    return "<span class='cssselectorcolor' stylezzzzzz=color:" + cssselectorcolor + ">" + rest + "</span>";
  }
  function cssPropertyMode(txt) {
    ...
    return "<span class='csspropertycolor' stylezzzzzz=color:" + csspropertycolor + ">" + done + rest + "</span>";
  }
  function cssPropertyValueMode(txt) {
    var rest = txt, done = "", s;
    rest = "<span class='cssdelimitercolor' stylezzzzzz=color:" + cssdelimitercolor + ">:</span>" + rest.substring(1);
    ...
    if (result.substr(result.length - 1, 1) == ";" && result.substr(result.length - 6, 6) != "&nbsp;" && result.substr(result.length - 4, 4) != "&lt;" && result.substr(result.length - 4, 4) != "&gt;" && result.substr(result.length - 5, 5) != "&amp;") {
      result = result.substring(0, result.length - 1) + "<span class='cssdelimitercolor' stylezzzzzz=color:" + cssdelimitercolor + ">;</span>";
    }
    return "<span class='csspropertyvaluecolor' stylezzzzzz=color:" + csspropertyvaluecolor + ">" + result + "</span>";
  }
  function cssImportantMode(txt) {
    return "<span class='cssimportantcolor' stylezzzzzz=color:" + cssimportantcolor + ";font-weight:bold;>" + txt + "</span>";
  }
  function jsMode(txt) {
    ...
    return "<span class='jscolor' stylezzzzzz=color:" + jscolor + ">" + rest + "</span>";
  }
  function jsRegExpMode(txt) {
    return "<span class='jsregexpcolor' stylezzzzzz=color:" + jsregexpcolor + ">" + txt + "</span>";
  }
  function jsStringMode(txt) {
    return "<span class='jsstringcolor' stylezzzzzz=color:" + jsstringcolor + ">" + txt + "</span>";
  }
  function jsStringTempMode(txt) {
    return "<span class='jsstringtempcolor' stylezzzzzz=color:" + jsstringtempcolor + ">" + txt + "</span>";
  }
  function jsKeywordMode(txt) {
    return "<span class='jskeywordcolor' stylezzzzzz=color:" + jskeywordcolor + ">" + txt + "</span>";
  }
  function jsNumberMode(txt) {
    return "<span class='jsnumbercolor' stylezzzzzz=color:" + jsnumbercolor + ">" + txt + "</span>";
  }
  function jsPropertyMode(txt) {
    return "<span class='jspropertycolor' stylezzzzzz=color:" + jspropertycolor + ">" + txt + "</span>";
  }
  ...
  function javaMode(txt) {
    ...
    return "<span class='javacolor' stylezzzzzz=color:" + javacolor + ">" + rest + "</span>";
  }
  function javaStringMode(txt) {
    return "<span class='javastringcolor' stylezzzzzz=color:" + javastringcolor + ">" + txt + "</span>";
  }
  function javaKeywordMode(txt) {
    return "<span class='javakeywordcolor' stylezzzzzz=color:" + javakeywordcolor + ">" + txt + "</span>";
  }
  function javaNumberMode(txt) {
    return "<span class='javanumbercolor' stylezzzzzz=color:" + javanumbercolor + ">" + txt + "</span>";
  }
  function javaPropertyMode(txt) {
    return "<span class='javapropertycolor' stylezzzzzz=color:" + javapropertycolor + ">" + txt + "</span>";
  }
  function kotlinMode(txt) {
    ...
    return "<span class='kotlincolor' stylezzzzzz=color:" + kotlincolor + ">" + rest + "</span>";
  }
  function kotlinStringMode(txt) {
    return "<span class='kotlinstringcolor' stylezzzzzz=color:" + kotlinstringcolor + ">" + txt + "</span>";
  }
  function kotlinKeywordMode(txt) {
    return "<span class='kotlinkeywordcolor' stylezzzzzz=color:" + kotlinkeywordcolor + ">" + txt + "</span>";
  }
  function kotlinNumberMode(txt) {
    return "<span class='kotlinnumbercolor' stylezzzzzz=color:" + kotlinnumbercolor + ">" + txt + "</span>";
  }
  function kotlinPropertyMode(txt) {
    return "<span class='kotlinpropertycolor' stylezzzzzz=color:" + kotlinpropertycolor + ">" + txt + "</span>";
  }
  function sqlMode(txt) {
    ...
    rest = done + rest;
    return "<span class='sqlcolor' stylezzzzzz=color:" + sqlcolor + ">" + rest + "</span>";
  }
  function sqlStringMode(txt) {
    return "<span class='sqlstringcolor' stylezzzzzz=color:" + sqlstringcolor + ">" + txt + "</span>";
  }
  function sqlKeywordMode(txt) {
    return "<span class='sqlkeywordcolor' stylezzzzzz=color:" + sqlkeywordcolor + ">" + txt + "</span>";
  }
  function sqlNumberMode(txt) {
    return "<span class='sqlnumbercolor' stylezzzzzz=color:" + sqlnumbercolor + ">" + txt + "</span>";
  }
  function phpMode(txt) {
    ...
    rest = done + rest;
    rest = "<span class='phptagcolor' stylezzzzzz=color:" + phptagcolor + ">&lt;" + rest.substr(4, 4) + "</span>" + rest.substring(8);
    if (rest.substr(rest.length - 5, 5) == "?&gt;") {
      rest = rest.substring(0, rest.length - 5) + "<span class='phptagcolor' stylezzzzzz=color:" + phptagcolor + ">?&gt;</span>";
    }
    return "<span class='phpcolor' stylezzzzzz=color:" + phpcolor + ">" + rest + "</span>";
  }
  function phpStringMode(txt) {
    return "<span class='phpstringcolor' stylezzzzzz=color:" + phpstringcolor + ">" + txt + "</span>";
  }
  function phpNumberMode(txt) {
    return "<span class='phpnumbercolor' stylezzzzzz=color:" + phpnumbercolor + ">" + txt + "</span>";
  }
  function phpKeywordMode(txt) {
    var glb = ["$GLOBALS", "$_SERVER", "$_REQUEST", "$_POST", "$_GET", "$_FILES", "$_ENV", "$_COOKIE", "$_SESSION"];
    if (glb.indexOf(txt.toUpperCase()) > -1) {
      if (glb.indexOf(txt) > -1) {
        return "<span class='phpglobalcolor' stylezzzzzz=color:" + phpglobalcolor + ">" + txt + "</span>";
      } else {
        return txt;
      }
    } else {
      return "<span class='phpkeywordcolor' stylezzzzzz=color:" + phpkeywordcolor + ">" + txt + "</span>";
    }
  }
  function pythonMode(txt) {
    ...
    rest = done + rest;
    return "<span class='pythoncolor' stylezzzzzz=color:" + pythoncolor + ">" + rest + "</span>";
  }
  function pythonStringMode(txt) {
    return "<span class='pythonstringcolor' stylezzzzzz=color:" + pythonstringcolor + ">" + txt + "</span>";
  }
  function pythonNumberMode(txt) {
    return "<span class='pythonnumbercolor' stylezzzzzz=color:" + pythonnumbercolor + ">" + txt + "</span>";
  }
  function pythonKeywordMode(txt) {
    return "<span class='pythonkeywordcolor' stylezzzzzz=color:" + pythonkeywordcolor + ">" + txt + "</span>";
  }
